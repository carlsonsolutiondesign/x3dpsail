...
X3D0 = (x3dpsail.X3D().setProfile("Immersive").setVersion("3.3")
      ...
      .setHead(x3dpsail.head()
        ...
        .addUnit(x3dpsail.unit().setCategory("angle").setConversionFactor(1.0).setName(x3dpsail.SFString("AngleUnitConversion")))
        .addUnit(x3dpsail.unit().setCategory("length").setConversionFactor(1.0).setName(x3dpsail.SFString("LengthUnitConversion")))
        ...
        .addMeta(x3dpsail.meta().setContent("27 December 2018").setName(x3dpsail.SFString("modified")))
...
"''')
        ...
        .addChild(x3dpsail.ProtoDeclare().setAppinfo("mimic a Material node and modulate fields as an animation effect").setDocumentation("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html").setName(x3dpsail.SFString("MaterialModulator"))
          .setProtoInterface(x3dpsail.ProtoInterface()
            .addField(x3dpsail.field().setAccessType("inputOutput").setName(x3dpsail.SFString("enabled")).setType("SFBool").setValue(x3dpsail.SFString("true")))
