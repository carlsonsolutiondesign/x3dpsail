...
X3D0 = (x3d.X3D().setProfile("Immersive").setVersion("3.3")
      ...
      .setHead(x3d.head()
        ...
        .addUnit(x3d.unit().setCategory("angle").setConversionFactor(1.0).setName(x3d.SFString("AngleUnitConversion")))
        .addUnit(x3d.unit().setCategory("length").setConversionFactor(1.0).setName(x3d.SFString("LengthUnitConversion")))
        ...
        .addMeta(x3d.meta().setContent("27 December 2018").setName(x3d.SFString("modified")))
...
"''')
        ...
        .addChild(x3d.ProtoDeclare().setAppinfo("mimic a Material node and modulate fields as an animation effect").setDocumentation("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html").setName(x3d.SFString("MaterialModulator"))
          .setProtoInterface(x3d.ProtoInterface()
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("enabled")).setType("SFBool").setValue(x3d.SFString("true")))
