...
X3D0 = (x3dpsail.X3D().setProfile("Immersive").setVersion("3.3")
      .setHead(x3dpsail.head()
        ...
        .addMeta(x3dpsail.meta().setContent("Simple X3D scene example: Hello World!").setName(x3dpsail.SFString("description")))
        .addMeta(x3dpsail.meta().setContent("30 October 2000").setName(x3dpsail.SFString("created")))
        .addMeta(x3dpsail.meta().setContent("14 April 2017").setName(x3dpsail.SFString("modified")))
        ...
        .addMeta(x3dpsail.meta().setContent("http://en.wikipedia.org/wiki/Hello_world").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("https://en.wikipedia.org/wiki/Hello#.22Hello.2C_World.22_computer_program").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("https://en.wikipedia.org/wiki/\"Hello,_World!\"_program").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("http://en.wikibooks.org/w/index.php?title=Computer_Programming/Hello_world").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("http://www.HelloWorldExample.net").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("http://www.web3D.org").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("http://www.web3d.org/realtime-3d/news/internationalization-x3d").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("http://www.web3d.org/x3d/content/examples/HelloWorld.x3d").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("http://X3dGraphics.com/examples/X3dForAdvancedModeling/HelloWorldScenes").setName(x3dpsail.SFString("reference")))
        .addMeta(x3dpsail.meta().setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter01TechnicalOverview/HelloWorld.x3d").setName(x3dpsail.SFString("identifier")))
        .addMeta(x3dpsail.meta().setContent("http://www.web3d.org/x3d/content/examples/license.html").setName(x3dpsail.SFString("license")))
        .addMeta(x3dpsail.meta().setContent("X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit").setName(x3dpsail.SFString("generator")))
