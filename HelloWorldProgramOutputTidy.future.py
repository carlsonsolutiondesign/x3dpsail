...
X3D0 = (x3dpsail.X3D().setProfile(x3dpsail.SFString("Immersive")).setVersion(x3dpsail.SFString("3.3"))
      ...
      .setHead(x3dpsail.head()
        ...
        .addComponent(x3dpsail.component().setLevel(x3dpsail.SFInt32(2)).setName(x3dpsail.SFString("CADGeometry")))
        .addComponent(x3dpsail.component().setLevel(x3dpsail.SFInt32(2)).setName(x3dpsail.SFString("DIS")))
        .addComponent(x3dpsail.component().setLevel(x3dpsail.SFInt32(1)).setName(x3dpsail.SFString("H-Anim")))
        .addUnit(x3dpsail.unit().setConversionFactor(x3dpsail.SFDouble(1.0)).setName(x3dpsail.SFString("AngleUnitConversion")).setCategory(x3dpsail.SFString("angle")))
        .addUnit(x3dpsail.unit().setConversionFactor(x3dpsail.SFDouble(1.0)).setName(x3dpsail.SFString("LengthUnitConversion")).setCategory(x3dpsail.SFString("length")))
        .addUnit(x3dpsail.unit().setConversionFactor(x3dpsail.SFDouble(4.4482)).setName(x3dpsail.SFString("ForceFromPoundsToNewtons")).setCategory(x3dpsail.SFString("force")))
        .addMeta(x3dpsail.meta().setContent(x3dpsail.SFString("HelloWorldProgramOutput.x3d")).setName(x3dpsail.SFString("title")))
        .addMeta(x3dpsail.meta().setContent(x3dpsail.SFString("continued development and testing in progress")).setName(x3dpsail.SFString("info")))
      ...
      .setScene(x3dpsail.Scene()
        .addChildren(x3dpsail.ViewpointGroup().setDescription(x3dpsail.SFString("Available viewpoints"))
        ...
        .addChildren(x3dpsail.LayerSet().setDEF(x3dpsail.SFString("scene.addChildLayerSetTest")))
          ...
          .addChild(x3dpsail.Anchor().setDescription(x3dpsail.SFString("select for X3D Java SAI Library (X3DJSAIL) description")).setUrl(x3dpsail.MFString(["../X3DJSAIL.html","http://www.web3d.org/specifications/java/X3DJSAIL.html"]))
            .addChild(x3dpsail.Shape().setDEF(x3dpsail.SFString("BoxShape"))
              .setAppearance(x3dpsail.Appearance()
                .setMaterial(x3dpsail.Material().setDEF(x3dpsail.SFString("GreenMaterial")).setDiffuseColor(x3dpsail.SFColor(0,1,1)).setTransparency(x3dpsail.SFFloat(0.1)).setEmissiveColor(x3dpsail.SFColor(0.8,0,0)))
...
"''')
        ...
        .addChild(x3dpsail.ProtoDeclare().setAppinfo(x3dpsail.SFString("tooltip: ArtDeco01Material prototype is a Material node")).setName(x3dpsail.SFString("ArtDeco01Material"))
          ...
          .setProtoBody(x3dpsail.ProtoBody()
            ...
            .addChild(x3dpsail.Material().setShininess(x3dpsail.SFFloat(0.127273)).setAmbientIntensity(x3dpsail.SFFloat(0.25)).setSpecularColor(x3dpsail.SFColor(0.276305,0.11431,0.139857)).setDiffuseColor(x3dpsail.SFColor(0.282435,0.085159,0.134462)))
        ...
        .addChild(x3dpsail.IMPORT().setImportedDEF(x3dpsail.SFString("WorldInfoDEF")).setInlineDEF(x3dpsail.SFString("inlineSceneDef")).setAS(x3dpsail.SFString("WorldInfoDEF2")))
        .addChild(x3dpsail.EXPORT().setLocalDEF(x3dpsail.SFString("WorldInfoDEF")).setAS(x3dpsail.SFString("WorldInfoDEF3")))
        .addChild(x3dpsail.ProtoDeclare().setAppinfo(x3dpsail.SFString("mimic a Material node and modulate fields as an animation effect")).setName(x3dpsail.SFString("MaterialModulator")).setDocumentation(x3dpsail.SFString("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html"))
          .setProtoInterface(x3dpsail.ProtoInterface()
            .addField(x3dpsail.field().setAccessType(x3dpsail.SFString("inputOutput")).setName(x3dpsail.SFString("enabled")).setType(x3dpsail.SFString("SFBool")).setValue(x3dpsail.SFString("true")))
...
"''')
        ...
        .addChild(x3dpsail.Group().setDEF(x3dpsail.SFString("DeclarativeGroupExample"))
          .addChild(x3dpsail.Shape()
            ...
            .setGeometry(x3dpsail.Cone().setBottomRadius(x3dpsail.SFFloat(0.05)).setHeight(x3dpsail.SFFloat(0.1)).setBottom(x3dpsail.SFBool(False))))
        ...
        .addChild(x3dpsail.Transform().setDEF(x3dpsail.SFString("SpecialtyNodes"))
          ...
          .setChildren(x3dpsail.ReceiverPdu().setReceivedPower(x3dpsail.SFFloat(0.0)))
          .setChildren(x3dpsail.SignalPdu())
          .setChildren(x3dpsail.TransmitterPdu().setRelativeAntennaLocation(x3dpsail.SFVec3f(0,0,0)).setTransmitFrequencyBandwidth(x3dpsail.SFFloat(0.0)))
          .setChildren(x3dpsail.DISEntityManager()
            .addMapping(x3dpsail.DISEntityTypeMapping()))
          .addChild(x3dpsail.HAnimHumanoid().setDEF(x3dpsail.SFString("TestHumanoidDEF")).setVersion(x3dpsail.SFString("2.0")).setName(x3dpsail.SFString("TestHumanoid"))))))
