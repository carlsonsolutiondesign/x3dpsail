...
X3D0 = (x3d.X3D().setProfile("Immersive").setVersion("3.3")
      ...
      .setHead(x3d.head()
        ...
        .addComponent(x3d.component().setLevel(3).setName(x3d.SFString("Navigation")))
        .addComponent(x3d.component().setLevel(1).setName(x3d.SFString("Layering")))
        .addComponent(x3d.component().setLevel(1).setName(x3d.SFString("Shaders")))
        .addComponent(x3d.component().setLevel(2).setName(x3d.SFString("CADGeometry")))
        .addComponent(x3d.component().setLevel(2).setName(x3d.SFString("DIS")))
        .addComponent(x3d.component().setLevel(1).setName(x3d.SFString("H-Anim")))
        .addUnit(x3d.unit().setConversionFactor(1.0).setName(x3d.SFString("AngleUnitConversion")).setCategory("angle"))
        .addUnit(x3d.unit().setConversionFactor(1.0).setName(x3d.SFString("LengthUnitConversion")).setCategory("length"))
        .addUnit(x3d.unit().setConversionFactor(4.4482).setName(x3d.SFString("ForceFromPoundsToNewtons")).setCategory("force"))
      ...
      .setScene(x3d.Scene()
        .addChild(x3d.ViewpointGroup().setDescription(x3d.SFString("Available viewpoints"))
          ...
          .addChild(x3d.Viewpoint().setDEF(x3d.SFString("TopDownView")).setPosition(x3d.SFVec3f([0,100,0])).setOrientation(x3d.SFRotation([1,0,0,-1.570796])).setDescription(x3d.SFString("top-down view from above"))))
        .addChild(x3d.NavigationInfo().setType(["EXAMINE","FLY","ANY"]))
        ...
        .addChild(x3d.WorldInfo().setUSE(x3d.SFString("WorldInfoDEF")))
        .addMetadata(x3d.MetadataString().setDEF(x3d.SFString("scene.addChildMetadata")).setValue(x3d.MFString(["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"])).setName(x3d.SFString("test")))
        .addLayerSet(x3d.LayerSet().setDEF(x3d.SFString("scene.addChildLayerSetTest")))
          ...
          .addChild(x3d.Anchor().setDescription(x3d.SFString("select for X3D Java SAI Library (X3DJSAIL) description")).setUrl(x3d.MFString(["../X3DJSAIL.html","http://www.web3d.org/specifications/java/X3DJSAIL.html"]))
            .addChild(x3d.Shape().setDEF(x3d.SFString("BoxShape"))
              .setAppearance(x3d.Appearance()
                .setMaterial(x3d.Material().setDEF(x3d.SFString("GreenMaterial")).setDiffuseColor([0,1,1]).setTransparency(0.1).setEmissiveColor([0.8,0,0]))
          ...
          .addChild(x3d.Shape()
            ...
            .setGeometry(x3d.Text().setString(["X3D Java","SAI Library","X3DJSAIL"])
              ...
              .setMetadata(x3d.MetadataSet().setName(x3d.SFString("EscapedQuotationMarksMetadataSet"))
                .addValue(x3d.MetadataString().setValue(x3d.MFString(["MFString example C, backslash-escaped quotes: He said, \"Immel did it!\""])).setName(x3d.SFString("quotesTestC")))
                .addValue(x3d.MetadataString().setValue(x3d.MFString(["checks MetadataSetObject addValue() method"])).setName(x3d.SFString("extraChildTest"))))
        ...
        .addChild(x3d.Group().setDEF(x3d.SFString("BackgroundGroup"))
          ...
          .addChild(x3d.Script().setDEF(x3d.SFString("colorTypeConversionScript"))
            .addField(x3d.field().setAccessType("inputOnly").setName(x3d.SFString("colorInput")).setType("SFColor"))
            .addField(x3d.field().setAccessType("outputOnly").setName(x3d.SFString("colorsOutput")).setType("MFColor")).setSourceCode('''\n"+
"ecmascript:\n"+
"\n"+
...
"''')
        ...
        .addChild(x3d.ProtoDeclare().setAppinfo("tooltip: ArtDeco01Material prototype is a Material node").setName(x3d.SFString("ArtDeco01Material"))
          .setProtoInterface(x3d.ProtoInterface()
            .addField(x3d.field().setAccessType("inputOutput").setAppinfo("tooltip for descriptionField").setName(x3d.SFString("description")).setType("SFString").setValue(x3d.SFString("ArtDeco01Material prototype is a Material node")))
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("enabled")).setType("SFBool").setValue(x3d.SFString("true"))))
          .setProtoBody(x3d.ProtoBody()
            # Initial node of ProtoBody determines prototype node type 

            .addChild(x3d.Material().setShininess(0.127273).setAmbientIntensity(0.25).setSpecularColor([0.276305,0.11431,0.139857]).setDiffuseColor([0.282435,0.085159,0.134462]))
        ...
        .addChild(x3d.ExternProtoDeclare().setAppinfo("this is a different Material node").setName(x3d.SFString("ArtDeco02Material")).setUrl(x3d.MFString(["http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02Material","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02Material"]))
          # [HelloWorldProgram diagnostic] artDeco02ExternProtoDeclare.getNodeType()=\"ERROR_UNKNOWN_EXTERNPROTODECLARE_NODE_TYPE: ExternProtoDeclare name='ArtDeco02Material' type cannot be remotely accessed at run time. TODO X3DJSAIL needs to add further capability that retrieves the ExternProtoDeclare file.\" 

          .addField(x3d.field().setAccessType("inputOutput").setAppinfo("tooltip for descriptionField").setName(x3d.SFString("description")).setType("SFString")))
        ...
        .addChild(x3d.IMPORT().setImportedDEF("WorldInfoDEF").setInlineDEF("inlineSceneDef").setAS("WorldInfoDEF2"))
        .addChild(x3d.EXPORT().setLocalDEF("WorldInfoDEF").setAS("WorldInfoDEF3"))
        .addChild(x3d.ProtoDeclare().setAppinfo("mimic a Material node and modulate fields as an animation effect").setName(x3d.SFString("MaterialModulator")).setDocumentation("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html")
          .setProtoInterface(x3d.ProtoInterface()
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("enabled")).setType("SFBool").setValue(x3d.SFString("true")))
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("diffuseColor")).setType("SFColor").setValue(x3d.SFString("0 0 0")))
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("emissiveColor")).setType("SFColor").setValue(x3d.SFString("0.05 0.05 0.5")))
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("specularColor")).setType("SFColor").setValue(x3d.SFString("0 0 0")))
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("transparency")).setType("SFFloat").setValue(x3d.SFString("0.0")))
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("shininess")).setType("SFFloat").setValue(x3d.SFString("0.0")))
            .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("ambientIntensity")).setType("SFFloat").setValue(x3d.SFString("0.0"))))
          .setProtoBody(x3d.ProtoBody()
            ...
            .addChild(x3d.Script().setDEF(x3d.SFString("MaterialModulatorScript"))
              .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("enabled")).setType("SFBool"))
              .addField(x3d.field().setAccessType("inputOutput").setName(x3d.SFString("diffuseColor")).setType("SFColor"))
              .addField(x3d.field().setAccessType("outputOnly").setName(x3d.SFString("newColor")).setType("SFColor"))
              .addField(x3d.field().setAccessType("inputOnly").setName(x3d.SFString("clockTrigger")).setType("SFTime"))
              .setIS(x3d.IS()
                .addConnect(x3d.connect().setNodeField(x3d.SFString("enabled")).setProtoField(x3d.SFString("enabled")))
...
"''')
        ...
        .addChild(x3d.Group().setDEF(x3d.SFString("DeclarativeGroupExample"))
          .addChild(x3d.Shape()
            .setMetadata(x3d.MetadataString().setDEF(x3d.SFString("FindableMetadataStringTest")).setValue(x3d.MFString(["test case"])).setName(x3d.SFString("findThisNameValue")))
            ...
            .setGeometry(x3d.Cone().setBottomRadius(0.05).setHeight(0.1).setBottom(False)))
        ...
        .addChild(x3d.Group()
          ...
          .addChild(x3d.ProtoDeclare().setName(x3d.SFString("NewWorldInfo"))
            .setProtoInterface(x3d.ProtoInterface()
              .addField(x3d.field().setAccessType("initializeOnly").setName(x3d.SFString("description")).setType("SFString")))
            .setProtoBody(x3d.ProtoBody()
        ...
        .addChild(x3d.Shape()
          .setAppearance(x3d.Appearance()
            ...
            .addChild(x3d.ProgramShader().setDEF(x3d.SFString("TestShader1"))
              .setPrograms(x3d.ShaderProgram().setDEF(x3d.SFString("TestShader2"))))
            .addChild(x3d.ProtoInstance().setDEF(x3d.SFString("TestShader3")).setName(x3d.SFString("ShaderProto")))
            .addChild(x3d.ComposedShader().setDEF(x3d.SFString("TestShader4"))
              .setParts(x3d.ShaderPart().setDEF(x3d.SFString("TestShader5"))))))
        .addChild(x3d.Transform().setDEF(x3d.SFString("SpecialtyNodes"))
          ...
          .addChild(x3d.EspduTransform())
          .addChild(x3d.ReceiverPdu().setReceivedPower(0.0))
          .addChild(x3d.SignalPdu())
          .addChild(x3d.TransmitterPdu().setRelativeAntennaLocation([0,0,0]).setTransmitFrequencyBandwidth(0.0))
          .addChild(x3d.DISEntityManager()
            .addMapping(x3d.DISEntityTypeMapping()))
          .addChild(x3d.HAnimHumanoid().setDEF(x3d.SFString("TestHumanoidDEF")).setVersion("2.0").setName(x3d.SFString("TestHumanoid"))))))
