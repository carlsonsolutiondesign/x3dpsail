...
X3D0 = X3D(profile="Immersive", version="3.3",    # x3dVersionComparisonTest for this model: supportsX3dVersion(X3DObject.VERSION_3_0)=true 
   ...
   head1 = head(    # comment #1 
    ...
    component3 = component(level=1, name="Layering"), 
    component4 = component(level=1, name="Shaders"), 
    component5 = component(level=2, name="CADGeometry"), 
    component6 = component(level=2, name="DIS"), 
    component7 = component(level=1, name="H-Anim"), 
    unit8 = unit(conversionFactor=1.0, name="AngleUnitConversion", category="angle"), 
    unit9 = unit(conversionFactor=1.0, name="LengthUnitConversion", category="length"), 
    unit10 = unit(conversionFactor=4.4482, name="ForceFromPoundsToNewtons", category="force"), 
   ...
   Scene31 = Scene(    ViewpointGroup32 = ViewpointGroup(description="Available viewpoints",      Viewpoint33 = Viewpoint(DEF="DefaultView", description="Hello X3DJSAIL"), 
     Viewpoint34 = Viewpoint(DEF="TopDownView", position=[0,100,0], orientation=[1,0,0,-1.570796], description="top-down view from above")), 
    NavigationInfo35 = NavigationInfo(type=["EXAMINE","FLY","ANY"]), 
    ...
    Transform57 = Transform(DEF="TextTransform", translation=[0,-1.5,0],      Shape58 = Shape(      Appearance59 = Appearance(       Material60 = Material(USE="GreenMaterial")), 
      Text61 = Text(string=["X3D Java","SAI Library","X3DJSAIL"],        # Comment example A, plain quotation marks: He said, \"Immel did it!\" 
       ...
       MetadataSet62 = MetadataSet(name="EscapedQuotationMarksMetadataSet",         MetadataString63 = MetadataString(value=["MFString example C, backslash-escaped quotes: He said, \"Immel did it!\""], name="quotesTestC"), 
        MetadataString64 = MetadataString(value=["checks MetadataSetObject addValue() method"], name="extraChildTest")), 
    ...
    Group73 = Group(DEF="BackgroundGroup",      Background74 = Background(DEF="GradualBackground"), 
     Script75 = Script(DEF="colorTypeConversionScript",       field76 = field(accessType="inputOnly", name="colorInput", type="SFColor"), 
      field77 = field(accessType="outputOnly", name="colorsOutput", type="MFColor"),       sourceCode = '''
ecmascript:
...
''', ), 
    ...
    ProtoDeclare83 = ProtoDeclare(appinfo="tooltip: ArtDeco01Material prototype is a Material node", name="ArtDeco01Material",      ProtoInterface84 = ProtoInterface(      field85 = field(accessType="inputOutput", appinfo="tooltip for descriptionField", name="description", type="SFString", value="ArtDeco01Material prototype is a Material node"), 
      field86 = field(accessType="inputOutput", name="enabled", type="SFBool", value="true")), 
     ProtoBody87 = ProtoBody(      # Initial node of ProtoBody determines prototype node type 

      Material88 = Material(shininess=0.127273, ambientIntensity=0.25, specularColor=[0.276305,0.11431,0.139857], diffuseColor=[0.282435,0.085159,0.134462]),       # [HelloWorldProgram diagnostic] should be connected to scene graph: artDeco01ProtoDeclare.getNodeType()=\"Material\" 
    ...
    ExternProtoDeclare93 = ExternProtoDeclare(appinfo="this is a different Material node", name="ArtDeco02Material", url=["http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02Material","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02Material"],      # [HelloWorldProgram diagnostic] artDeco02ExternProtoDeclare.getNodeType()=\"ERROR_UNKNOWN_EXTERNPROTODECLARE_NODE_TYPE: ExternProtoDeclare name='ArtDeco02Material' type cannot be remotely accessed at run time. TODO X3DJSAIL needs to add further capability that retrieves the ExternProtoDeclare file.\" 

     field94 = field(accessType="inputOutput", appinfo="tooltip for descriptionField", name="description", type="SFString")),     # Tested ArtDeco01ProtoInstance, ArtDeco02ProtoInstance for improper node type when ProtoInstance is added in wrong place 
    ...
    IMPORT110 = IMPORT(importedDEF="WorldInfoDEF", inlineDEF="inlineSceneDef", AS="WorldInfoDEF2"), 
    EXPORT111 = EXPORT(localDEF="WorldInfoDEF", AS="WorldInfoDEF3"), 
    ProtoDeclare112 = ProtoDeclare(appinfo="mimic a Material node and modulate fields as an animation effect", name="MaterialModulator", documentation="http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html",      ProtoInterface113 = ProtoInterface(      field114 = field(accessType="inputOutput", name="enabled", type="SFBool", value="true"), 
      field115 = field(accessType="inputOutput", name="diffuseColor", type="SFColor", value="0 0 0"), 
      field116 = field(accessType="inputOutput", name="emissiveColor", type="SFColor", value="0.05 0.05 0.5"), 
      field117 = field(accessType="inputOutput", name="specularColor", type="SFColor", value="0 0 0"), 
      field118 = field(accessType="inputOutput", name="transparency", type="SFFloat", value="0.0"), 
      field119 = field(accessType="inputOutput", name="shininess", type="SFFloat", value="0.0"), 
      field120 = field(accessType="inputOutput", name="ambientIntensity", type="SFFloat", value="0.0")), 
     ProtoBody121 = ProtoBody(      Material122 = Material(DEF="MaterialNode",        IS123 = IS(        connect124 = connect(nodeField="diffuseColor", protoField="diffuseColor"), 
      ...
      Script130 = Script(DEF="MaterialModulatorScript",        field131 = field(accessType="inputOutput", name="enabled", type="SFBool"), 
       field132 = field(accessType="inputOutput", name="diffuseColor", type="SFColor"), 
       field133 = field(accessType="outputOnly", name="newColor", type="SFColor"), 
       field134 = field(accessType="inputOnly", name="clockTrigger", type="SFTime"), 
...
''', ))),     # Test success: declarative statement createDeclarativeShapeTests() 
    ...
    Group138 = Group(DEF="DeclarativeGroupExample",      Shape139 = Shape(      MetadataString140 = MetadataString(DEF="FindableMetadataStringTest", value=["test case"], name="findThisNameValue"), 
      ...
      Cone143 = Cone(bottomRadius=0.05, height=0.1, bottom=False)),      # Test success: declarativeGroup.addChild() singleton pipeline method 
    ...
    Group153 = Group(     # Test MFNode children array as an ordered list consisting of comments, statements, ProtoInstance and nodes 
     ...
     ProtoDeclare154 = ProtoDeclare(name="NewWorldInfo",       ProtoInterface155 = ProtoInterface(       field156 = field(accessType="initializeOnly", name="description", type="SFString")), 
    ...
    Transform174 = Transform(DEF="SpecialtyNodes",      CADLayer175 = CADLayer(      CADAssembly176 = CADAssembly(       CADPart177 = CADPart(        CADFace178 = CADFace()))), 
     ...
     ReceiverPdu180 = ReceiverPdu(receivedPower=0.0), 
     SignalPdu181 = SignalPdu(), 
     TransmitterPdu182 = TransmitterPdu(relativeAntennaLocation=[0,0,0], transmitFrequencyBandwidth=0.0), 
     DISEntityManager183 = DISEntityManager(      DISEntityTypeMapping184 = DISEntityTypeMapping()), 
     HAnimHumanoid185 = HAnimHumanoid(DEF="TestHumanoidDEF", version="2.0", name="TestHumanoid"))))
