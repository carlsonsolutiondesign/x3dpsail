...
X3D0 = (X3Dpackage.X3D().setProfile("Immersive").setVersion("3.3")
      ...
      .setHead(X3Dpackage.head()
        ...
        .addComponent(X3Dpackage.component().setLevel(2).setName("CADGeometry"))
        .addComponent(X3Dpackage.component().setLevel(2).setName("DIS"))
        .addComponent(X3Dpackage.component().setLevel(1).setName("H-Anim"))
        ...
        .addUnit(X3Dpackage.unit(setCategory = "force").setConversionFactor(4.4482).setName("ForceFromPoundsToNewtons"))
      ...
      .setScene(X3Dpackage.Scene()
        .addChildren(X3Dpackage.ViewpointGroup().setDescription("Available viewpoints")
          ...
          .addChildren(X3Dpackage.Viewpoint().setDEF("TopDownView").setPosition([0,100,0]).setOrientation([1,0,0,-1.570796]).setDescription("top-down view from above")))
        ...
        .addChildren(X3Dpackage.WorldInfo().setUSE("WorldInfoDEF"))
        .addMetadata(X3Dpackage.MetadataString().setDEF("scene.addChildMetadata").setValue(["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"]).setName("test"))
        .addChildren(X3Dpackage.LayerSet().setDEF("scene.addChildLayerSetTest"))
          ...
          .addChildren(X3Dpackage.Anchor().setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(["../X3DJSAIL.html","http://www.web3d.org/specifications/java/X3DJSAIL.html"])
            .addChildren(X3Dpackage.Shape().setDEF("BoxShape")
              .setAppearance(X3Dpackage.Appearance()
                .setMaterial(X3Dpackage.Material().setDEF("GreenMaterial").setDiffuseColor([0,1,1]).setTransparency(0.1).setEmissiveColor([0.8,0,0]))
          ...
          .addChildren(X3Dpackage.Shape()
            ...
            .setGeometry(X3Dpackage.Text().setString(["X3D Java","SAI Library","X3DJSAIL"])
              ...
              .setMetadata(X3Dpackage.MetadataSet().setName("EscapedQuotationMarksMetadataSet")
                .addValue(X3Dpackage.MetadataString().setValue(["MFString example C, backslash-escaped quotes: He said, \"Immel did it!\""]).setName("quotesTestC"))
                .addValue(X3Dpackage.MetadataString().setValue(["checks MetadataSetObject addValue() method"]).setName("extraChildTest")))
...
"''')
        ...
        .addChildren(X3Dpackage.ProtoDeclare().setAppinfo("tooltip: ArtDeco01Material prototype is a Material node").setName("ArtDeco01Material")
          ...
          .setProtoBody(X3Dpackage.ProtoBody()
            ...
            .addChildren(X3Dpackage.Material().setShininess(0.127273).setAmbientIntensity(0.25).setSpecularColor([0.276305,0.11431,0.139857]).setDiffuseColor([0.282435,0.085159,0.134462]))
        ...
        .addChildren(X3Dpackage.IMPORT().setImportedDEF("WorldInfoDEF").setInlineDEF("inlineSceneDef").setAS("WorldInfoDEF2"))
        .addChildren(X3Dpackage.EXPORT().setLocalDEF("WorldInfoDEF").setAS("WorldInfoDEF3"))
        .addChildren(X3Dpackage.ProtoDeclare().setAppinfo("mimic a Material node and modulate fields as an animation effect").setName("MaterialModulator").setDocumentation("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html")
          .setProtoInterface(X3Dpackage.ProtoInterface()
            .addField(X3Dpackage.field().setAccessType("inputOutput").setName("enabled").setType("SFBool").setValue("true"))
...
"''')
        ...
        .addChildren(X3Dpackage.Group().setDEF("DeclarativeGroupExample")
          .addChildren(X3Dpackage.Shape()
            .setMetadata(X3Dpackage.MetadataString().setDEF("FindableMetadataStringTest").setValue(["test case"]).setName("findThisNameValue"))
            ...
            .setGeometry(X3Dpackage.Cone(setBottomRadius = 0.05, setHeight = 0.1, setBottom = False)))
        ...
        .addChildren(X3Dpackage.Shape()
          .setAppearance(X3Dpackage.Appearance()
            ...
            .addShaders(X3Dpackage.ProgramShader().setDEF("TestShader1")
              .setPrograms(X3Dpackage.ShaderProgram().setDEF("TestShader2")))
            ...
            .addShaders(X3Dpackage.ComposedShader().setDEF("TestShader4")
              .setParts(X3Dpackage.ShaderPart().setDEF("TestShader5")))))
        .addChildren(X3Dpackage.Transform().setDEF("SpecialtyNodes")
          ...
          .addChildren(X3Dpackage.EspduTransform())
          .addChildren(X3Dpackage.ReceiverPdu().setReceivedPower(0.0))
          .addChildren(X3Dpackage.SignalPdu())
          .addChildren(X3Dpackage.TransmitterPdu().setRelativeAntennaLocation([0,0,0]).setTransmitFrequencyBandwidth(0.0))
          .addChildren(X3Dpackage.DISEntityManager()
            .addMapping(X3Dpackage.DISEntityTypeMapping()))
          .addChildren(X3Dpackage.HAnimHumanoid().setDEF("TestHumanoidDEF").setVersion("2.0").setName("TestHumanoid")))))
