...
X3D0 = (X3Dpackage.X3D().setProfile("Immersive").setVersion("3.3")
      ...
      .setScene(X3Dpackage.Scene()
        ...
        .addChildren(X3Dpackage.WorldInfo().setUSE("WorldInfoDEF"))
        .addChildren(X3Dpackage.MetadataString().setDEF("scene.addChildMetadata").setValue(["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"]).setName("test"))
