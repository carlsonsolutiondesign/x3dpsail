...
X3D0 = X3D(profile="Immersive", version="3.3",    head1 = head(    meta2 = meta(content="HelloWorld.x3d", name="title"), 
    ...
    meta5 = meta(content="28 July 2015", name="modified"), 
   ...
   Scene25 = Scene(    # Example scene to illustrate X3D nodes and fields (XML elements and attributes) 
    ...
    Group26 = Group(     Viewpoint27 = Viewpoint(DEF="ViewUpClose", centerOfRotation=[0,-1,0], description="Hello world!", position=[0,-1,7]), 
     Transform28 = Transform(rotation=[0,1,0,3],       Shape29 = Shape(       Sphere30 = Sphere(), 
       Appearance31 = Appearance(        Material32 = Material(DEF="MaterialLightBlue", diffuseColor=[0.1,0.5,1]), 
        ImageTexture33 = ImageTexture(DEF="ImageCloudlessEarth", url=["earth-topo.png","earth-topo.jpg","earth-topo-small.gif","http://www.web3d.org/x3d/content/examples/Basic/earth-topo.png","http://www.web3d.org/x3d/content/examples/Basic/earth-topo.jpg","http://www.web3d.org/x3d/content/examples/Basic/earth-topo-small.gif"])))), 
     Transform34 = Transform(translation=[0,-2,0],       Shape35 = Shape(       Text36 = Text(DEF="TextMessage", string=["Hello","world!"],         FontStyle37 = FontStyle(justify=["MIDDLE","MIDDLE"])), 
       Appearance38 = Appearance(        Material39 = Material(USE="MaterialLightBlue")))))))
