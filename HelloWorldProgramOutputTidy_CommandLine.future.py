...
X3D0 = (x3dpsail.X3D().setProfile(x3dpsail.SFString("Immersive")).setVersion(x3dpsail.SFString("3.3"))
      ...
      .setScene(x3dpsail.Scene()
        ...
        .addChild(x3dpsail.LayerSet().setDEF(x3dpsail.SFString("scene.addChildLayerSetTest")))
...
"''')
        ...
        .addChild(x3dpsail.Transform().setDEF(x3dpsail.SFString("SpecialtyNodes"))
          ...
          .addChild(x3dpsail.ReceiverPdu().setReceivedPower(x3dpsail.SFFloat(0.0)))
          .addChild(x3dpsail.SignalPdu())
          .addChild(x3dpsail.TransmitterPdu().setRelativeAntennaLocation(x3dpsail.SFVec3f(0,0,0)).setTransmitFrequencyBandwidth(x3dpsail.SFFloat(0.0)))
