...
X3D0 = (x3dpsail.X3D().setProfile(x3dpsail.SFString("Immersive")).setVersion(x3dpsail.SFString("3.3"))
      ...
      .setHead(x3dpsail.head()
        ...
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("CADGeometry")).setLevel(x3dpsail.SFInt32(2)))
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("DIS")).setLevel(x3dpsail.SFInt32(2)))
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("H-Anim")).setLevel(x3dpsail.SFInt32(1)))
        .addUnit(x3dpsail.unit().setName(x3dpsail.SFString("AngleUnitConversion")).setCategory(x3dpsail.SFString("angle")).setConversionFactor(x3dpsail.SFDouble(1.0)))
        .addUnit(x3dpsail.unit().setName(x3dpsail.SFString("LengthUnitConversion")).setCategory(x3dpsail.SFString("length")).setConversionFactor(x3dpsail.SFDouble(1.0)))
        .addUnit(x3dpsail.unit().setName(x3dpsail.SFString("ForceFromPoundsToNewtons")).setCategory(x3dpsail.SFString("force")).setConversionFactor(x3dpsail.SFDouble(4.4482)))
      ...
      .setScene(x3dpsail.Scene()
          ...
          .addChild(x3dpsail.Shape()
            ...
            .setGeometry(x3dpsail.Text().setString(x3dpsail.MFString(["X3D Java","SAI Library","X3DJSAIL"]))
              ...
              .setMetadata(x3dpsail.MetadataSet().setName("EscapedQuotationMarksMetadataSet")
                .setValue(x3dpsail.MetadataString().setName(x3dpsail.SFString("quotesTestC")).setValue(x3dpsail.MFString(["MFString example C, backslash-escaped quotes: He said, \"Immel did it!\""])))
                .setValue(x3dpsail.MetadataString().setName(x3dpsail.SFString("extraChildTest")).setValue(x3dpsail.MFString(["checks MetadataSetObject addValue() method"]))))
        ...
        .addChild(x3dpsail.Group().setDEF(x3dpsail.SFString("BackgroundGroup"))
          ...
          .addChild(x3dpsail.Script().setDEF(x3dpsail.SFString("colorTypeConversionScript"))
            ...
            .addField(x3dpsail.field().setName(x3dpsail.SFString("colorsOutput")).setAccessType(x3dpsail.SFString("outputOnly")).setType(x3dpsail.SFString("MFColor"))).setSourceCode('''\n"+
"ecmascript:\n"+
"\n"+
...
"''')
        ...
        .addChild(x3dpsail.ProtoDeclare().setName(x3dpsail.SFString("MaterialModulator")).setAppinfo(x3dpsail.SFString("mimic a Material node and modulate fields as an animation effect")).setDocumentation(x3dpsail.SFString("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html"))
          .setProtoInterface(x3dpsail.ProtoInterface()
            ...
            .addField(x3dpsail.field().setName(x3dpsail.SFString("transparency")).setAccessType(x3dpsail.SFString("inputOutput")).setType(x3dpsail.SFString("SFFloat")).setValue(x3dpsail.SFString("0.0")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("shininess")).setAccessType(x3dpsail.SFString("inputOutput")).setType(x3dpsail.SFString("SFFloat")).setValue(x3dpsail.SFString("0.0")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("ambientIntensity")).setAccessType(x3dpsail.SFString("inputOutput")).setType(x3dpsail.SFString("SFFloat")).setValue(x3dpsail.SFString("0.0"))))
          .setProtoBody(x3dpsail.ProtoBody()
...
"''')
        ...
        .addChild(x3dpsail.Group()
          ...
          .addChild(x3dpsail.ProtoDeclare().setName(x3dpsail.SFString("NewWorldInfo"))
            .setProtoInterface(x3dpsail.ProtoInterface()
              .addField(x3dpsail.field().setName(x3dpsail.SFString("description")).setAccessType(x3dpsail.SFString("initializeOnly")).setType(x3dpsail.SFString("SFString"))))
            .setProtoBody(x3dpsail.ProtoBody()
        ...
        .addChild(x3dpsail.Transform().setDEF(x3dpsail.SFString("SpecialtyNodes"))
          ...
          .addChild(x3dpsail.EspduTransform().setGeoSystem(x3dpsail.MFString(["GD","WE"])))
          .addChild(x3dpsail.ReceiverPdu().setGeoSystem(x3dpsail.MFString(["GD","WE"])))
          .addChild(x3dpsail.SignalPdu().setGeoSystem(x3dpsail.MFString(["GD","WE"])))
          .addChild(x3dpsail.TransmitterPdu().setGeoSystem(x3dpsail.MFString(["GD","WE"])))
          .addChild(x3dpsail.DISEntityManager()
            .addMapping(x3dpsail.DISEntityTypeMapping()))
          .addChild(x3dpsail.HAnimHumanoid().setDEF(x3dpsail.SFString("TestHumanoidDEF")).setName(x3dpsail.SFString("TestHumanoid")).setVersion(x3dpsail.SFString("2.0"))))))
