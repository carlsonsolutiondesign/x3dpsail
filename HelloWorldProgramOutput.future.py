...
X3D0 = (x3dpsail.X3D().setProfile("Immersive").setVersion("3.3")
      ...
      .setHead(x3dpsail.head()
        ...
        .addComponent(x3dpsail.component().setName("Navigation").setLevel(3))
        .addComponent(x3dpsail.component().setName("Layering").setLevel(1))
        .addComponent(x3dpsail.component().setName("Shaders").setLevel(1))
        .addComponent(x3dpsail.component().setName("CADGeometry").setLevel(2))
        .addComponent(x3dpsail.component().setName("DIS").setLevel(2))
        .addComponent(x3dpsail.component().setName("H-Anim").setLevel(1))
        .addUnit(x3dpsail.unit().setName("AngleUnitConversion").setCategory("angle").setConversionFactor(1.0))
        .addUnit(x3dpsail.unit().setName("LengthUnitConversion").setCategory("length").setConversionFactor(1.0))
        .addUnit(x3dpsail.unit().setName("ForceFromPoundsToNewtons").setCategory("force").setConversionFactor(4.4482))
      ...
      .setScene(x3dpsail.Scene()
        .addChild(x3dpsail.ViewpointGroup().setDescription(x3dpsail.SFString("Available viewpoints"))
          .addChild(x3dpsail.Viewpoint().setDEF(x3dpsail.SFString("DefaultView")).setDescription("Hello X3DJSAIL"))
          .addChild(x3dpsail.Viewpoint().setDEF(x3dpsail.SFString("TopDownView")).setDescription(x3dpsail.SFString("top-down view from above")).setOrientation(1,0,0,-1.570796).setPosition(0,100,0)))
        .addChild(x3dpsail.NavigationInfo().setAvatarSize([0.25,1.6,0.75]).setTransitionType(["LINEAR"]).setType(["EXAMINE","FLY","ANY"]))
        ...
        .addChild(x3dpsail.WorldInfo().setUSE(x3dpsail.SFString("WorldInfoDEF")))
        .addMetadata(x3dpsail.MetadataString().setDEF(x3dpsail.SFString("scene.addChildMetadata")).setName(x3dpsail.SFString("test")).setValue(["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"]))
        .addLayerSet(x3dpsail.LayerSet().setDEF("scene.addChildLayerSetTest").setOrder([0]))
          ...
          .addChild(x3dpsail.Anchor().setDescription("select for X3D Java SAI Library (X3DJSAIL) description").setUrl(["../X3DJSAIL.html","http://www.web3d.org/specifications/java/X3DJSAIL.html"])
            .addChild(x3dpsail.Shape().setDEF("BoxShape")
              .setAppearance(x3dpsail.Appearance()
                .setMaterial(x3dpsail.Material().setDEF("GreenMaterial").setDiffuseColor(0,1,1).setEmissiveColor(0.8,0,0).setTransparency(0.1))
          ...
          .addChild(x3dpsail.Shape()
            ...
            .setGeometry(x3dpsail.Text().setString(["X3D Java","SAI Library","X3DJSAIL"])
              ...
              .setMetadata(x3dpsail.MetadataSet().setName("EscapedQuotationMarksMetadataSet")
                .setValue(x3dpsail.MetadataString().setName("quotesTestC").setValue(["MFString example C, backslash-escaped quotes: He said, \"Immel did it!\""]))
                .setValue(x3dpsail.MetadataString().setName("extraChildTest").setValue(["checks MetadataSetObject addValue() method"])))
              .setFontStyle(x3dpsail.FontStyle().setFamily(["SERIF"]).setJustify(["MIDDLE","MIDDLE"]))))
        ...
        .addChild(x3dpsail.Group().setDEF("BackgroundGroup")
          ...
          .addChild(x3dpsail.Script().setDEF("colorTypeConversionScript")
            .addField(x3dpsail.field().setName("colorInput").setAccessType("inputOnly").setType("SFColor"))
            .addField(x3dpsail.field().setName("colorsOutput").setAccessType("outputOnly").setType("MFColor")).setSourceCode('''\n"+
"ecmascript:\n"+
"\n"+
...
"''')
        ...
        .addChild(x3dpsail.ProtoDeclare().setName("ArtDeco01Material").setAppinfo("tooltip: ArtDeco01Material prototype is a Material node")
          .setProtoInterface(x3dpsail.ProtoInterface()
            .addField(x3dpsail.field().setName("description").setAccessType("inputOutput").setAppinfo("tooltip for descriptionField").setType("SFString").setValue("ArtDeco01Material prototype is a Material node"))
            .addField(x3dpsail.field().setName("enabled").setAccessType("inputOutput").setType("SFBool").setValue("true")))
          .setProtoBody(x3dpsail.ProtoBody()
            # Initial node of ProtoBody determines prototype node type 

            .addChild(x3dpsail.Material().setAmbientIntensity(0.25).setDiffuseColor(0.282435,0.085159,0.134462).setShininess(0.127273).setSpecularColor(0.276305,0.11431,0.139857))
        ...
        .addChild(x3dpsail.ExternProtoDeclare().setName("ArtDeco02Material").setAppinfo("this is a different Material node").setUrl(["http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02Material","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02Material"])
          # [HelloWorldProgram diagnostic] artDeco02ExternProtoDeclare.getNodeType()=\"ERROR_UNKNOWN_EXTERNPROTODECLARE_NODE_TYPE: ExternProtoDeclare name='ArtDeco02Material' type cannot be remotely accessed at run time. TODO X3DJSAIL needs to add further capability that retrieves the ExternProtoDeclare file.\" 

          .addField(x3dpsail.field().setName("description").setAccessType("inputOutput").setAppinfo("tooltip for descriptionField").setType("SFString")))
        ...
        .addChild(x3dpsail.IMPORT().setAS("WorldInfoDEF2").setImportedDEF("WorldInfoDEF").setInlineDEF("inlineSceneDef"))
        .addChild(x3dpsail.EXPORT().setAS("WorldInfoDEF3").setLocalDEF("WorldInfoDEF"))
        .addChild(x3dpsail.ProtoDeclare().setName("MaterialModulator").setAppinfo("mimic a Material node and modulate fields as an animation effect").setDocumentation("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html")
          .setProtoInterface(x3dpsail.ProtoInterface()
            .addField(x3dpsail.field().setName("enabled").setAccessType("inputOutput").setType("SFBool").setValue("true"))
            .addField(x3dpsail.field().setName("diffuseColor").setAccessType("inputOutput").setType("SFColor").setValue("0 0 0"))
            .addField(x3dpsail.field().setName("emissiveColor").setAccessType("inputOutput").setType("SFColor").setValue("0.05 0.05 0.5"))
            .addField(x3dpsail.field().setName("specularColor").setAccessType("inputOutput").setType("SFColor").setValue("0 0 0"))
            .addField(x3dpsail.field().setName("transparency").setAccessType("inputOutput").setType("SFFloat").setValue("0.0"))
            .addField(x3dpsail.field().setName("shininess").setAccessType("inputOutput").setType("SFFloat").setValue("0.0"))
            .addField(x3dpsail.field().setName("ambientIntensity").setAccessType("inputOutput").setType("SFFloat").setValue("0.0")))
          .setProtoBody(x3dpsail.ProtoBody()
            ...
            .addChild(x3dpsail.Script().setDEF("MaterialModulatorScript")
              .addField(x3dpsail.field().setName("enabled").setAccessType("inputOutput").setType("SFBool"))
              .addField(x3dpsail.field().setName("diffuseColor").setAccessType("inputOutput").setType("SFColor"))
              .addField(x3dpsail.field().setName("newColor").setAccessType("outputOnly").setType("SFColor"))
              .addField(x3dpsail.field().setName("clockTrigger").setAccessType("inputOnly").setType("SFTime"))
              .setIS(x3dpsail.IS()
                .addConnect(x3dpsail.connect().setNodeField("enabled").setProtoField("enabled"))
...
"''')
        ...
        .addChild(x3dpsail.Group().setDEF("DeclarativeGroupExample")
          .addChild(x3dpsail.Shape()
            .setMetadata(x3dpsail.MetadataString().setDEF("FindableMetadataStringTest").setName("findThisNameValue").setValue(["test case"]))
            ...
            .setGeometry(x3dpsail.Cone().setBottom(False).setBottomRadius(0.05).setHeight(0.1)))
        ...
        .addChild(x3dpsail.Group()
          ...
          .addChild(x3dpsail.ProtoDeclare().setName("NewWorldInfo")
            .setProtoInterface(x3dpsail.ProtoInterface()
              .addField(x3dpsail.field().setName("description").setAccessType("initializeOnly").setType("SFString")))
            .setProtoBody(x3dpsail.ProtoBody()
        ...
        .addChild(x3dpsail.Shape()
          .setAppearance(x3dpsail.Appearance()
            ...
            .addShaders(x3dpsail.ProgramShader().setDEF("TestShader1")
              .addPrograms(x3dpsail.ShaderProgram().setDEF("TestShader2")))
            ...
            .addShaders(x3dpsail.ComposedShader().setDEF("TestShader4")
              .addParts(x3dpsail.ShaderPart().setDEF("TestShader5")))))
        .addChild(x3dpsail.Transform().setDEF("SpecialtyNodes")
          ...
          .addChild(x3dpsail.EspduTransform().setGeoSystem(["GD","WE"]))
          .addChild(x3dpsail.ReceiverPdu().setGeoSystem(["GD","WE"]))
          .addChild(x3dpsail.SignalPdu().setGeoSystem(["GD","WE"]))
          .addChild(x3dpsail.TransmitterPdu().setGeoSystem(["GD","WE"]))
          .addChild(x3dpsail.DISEntityManager()
            .addMapping(x3dpsail.DISEntityTypeMapping()))
          .addChild(x3dpsail.HAnimHumanoid().setDEF("TestHumanoidDEF").setName("TestHumanoid").setVersion("2.0")))))
