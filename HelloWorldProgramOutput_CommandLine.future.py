...
X3D0 = (x3dpsail.X3D().setProfile("Immersive").setVersion("3.3")
      ...
      .setHead(x3dpsail.head()
        ...
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("Navigation")).setLevel(3))
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("Layering")).setLevel(1))
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("Shaders")).setLevel(1))
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("CADGeometry")).setLevel(2))
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("DIS")).setLevel(2))
        .addComponent(x3dpsail.component().setName(x3dpsail.SFString("H-Anim")).setLevel(1))
        .addUnit(x3dpsail.unit().setName(x3dpsail.SFString("AngleUnitConversion")).setCategory("angle").setConversionFactor(1.0))
        .addUnit(x3dpsail.unit().setName(x3dpsail.SFString("LengthUnitConversion")).setCategory("length").setConversionFactor(1.0))
        .addUnit(x3dpsail.unit().setName(x3dpsail.SFString("ForceFromPoundsToNewtons")).setCategory("force").setConversionFactor(4.4482))
      ...
      .setScene(x3dpsail.Scene()
          ...
          .addChild(x3dpsail.Anchor().setDescription(x3dpsail.SFString("select for X3D Java SAI Library (X3DJSAIL) description")).setUrl(x3dpsail.MFString(["../X3DJSAIL.html","http://www.web3d.org/specifications/java/X3DJSAIL.html"]))
            .addChild(x3dpsail.Shape().setDEF(x3dpsail.SFString("BoxShape"))
              .setAppearance(x3dpsail.Appearance()
                .setMaterial(x3dpsail.Material().setDEF(x3dpsail.SFString("GreenMaterial")).setDiffuseColor([0,1,1]).setEmissiveColor([0.8,0,0]).setTransparency(0.1))
        ...
        .addChild(x3dpsail.Group().setDEF(x3dpsail.SFString("BackgroundGroup"))
          ...
          .addChild(x3dpsail.Script().setDEF(x3dpsail.SFString("colorTypeConversionScript"))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("colorInput")).setAccessType("inputOnly").setType("SFColor"))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("colorsOutput")).setAccessType("outputOnly").setType("MFColor")).setSourceCode('''\n"+
"ecmascript:\n"+
"\n"+
...
"''')
        ...
        .addChild(x3dpsail.ProtoDeclare().setName(x3dpsail.SFString("ArtDeco01Material")).setAppinfo("tooltip: ArtDeco01Material prototype is a Material node")
          .setProtoInterface(x3dpsail.ProtoInterface()
            .addField(x3dpsail.field().setName(x3dpsail.SFString("description")).setAccessType("inputOutput").setAppinfo("tooltip for descriptionField").setType("SFString").setValue(x3dpsail.SFString("ArtDeco01Material prototype is a Material node")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("enabled")).setAccessType("inputOutput").setType("SFBool").setValue(x3dpsail.SFString("true"))))
        ...
        .addChild(x3dpsail.ExternProtoDeclare().setName(x3dpsail.SFString("ArtDeco02Material")).setAppinfo("this is a different Material node").setUrl(x3dpsail.MFString(["http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02Material","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3dv#ArtDeco02Material"]))
          # [HelloWorldProgram diagnostic] artDeco02ExternProtoDeclare.getNodeType()=\"ERROR_UNKNOWN_EXTERNPROTODECLARE_NODE_TYPE: ExternProtoDeclare name='ArtDeco02Material' type cannot be remotely accessed at run time. TODO X3DJSAIL needs to add further capability that retrieves the ExternProtoDeclare file.\" 

          .addField(x3dpsail.field().setName(x3dpsail.SFString("description")).setAccessType("inputOutput").setAppinfo("tooltip for descriptionField").setType("SFString")))
        ...
        .addChild(x3dpsail.ProtoDeclare().setName(x3dpsail.SFString("MaterialModulator")).setAppinfo("mimic a Material node and modulate fields as an animation effect").setDocumentation("http://x3dgraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/MaterialModulatorIndex.html")
          .setProtoInterface(x3dpsail.ProtoInterface()
            .addField(x3dpsail.field().setName(x3dpsail.SFString("enabled")).setAccessType("inputOutput").setType("SFBool").setValue(x3dpsail.SFString("true")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("diffuseColor")).setAccessType("inputOutput").setType("SFColor").setValue(x3dpsail.SFString("0 0 0")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("emissiveColor")).setAccessType("inputOutput").setType("SFColor").setValue(x3dpsail.SFString("0.05 0.05 0.5")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("specularColor")).setAccessType("inputOutput").setType("SFColor").setValue(x3dpsail.SFString("0 0 0")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("transparency")).setAccessType("inputOutput").setType("SFFloat").setValue(x3dpsail.SFString("0.0")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("shininess")).setAccessType("inputOutput").setType("SFFloat").setValue(x3dpsail.SFString("0.0")))
            .addField(x3dpsail.field().setName(x3dpsail.SFString("ambientIntensity")).setAccessType("inputOutput").setType("SFFloat").setValue(x3dpsail.SFString("0.0"))))
          .setProtoBody(x3dpsail.ProtoBody()
            ...
            .addChild(x3dpsail.Script().setDEF(x3dpsail.SFString("MaterialModulatorScript"))
              .addField(x3dpsail.field().setName(x3dpsail.SFString("enabled")).setAccessType("inputOutput").setType("SFBool"))
              .addField(x3dpsail.field().setName(x3dpsail.SFString("diffuseColor")).setAccessType("inputOutput").setType("SFColor"))
              .addField(x3dpsail.field().setName(x3dpsail.SFString("newColor")).setAccessType("outputOnly").setType("SFColor"))
              .addField(x3dpsail.field().setName(x3dpsail.SFString("clockTrigger")).setAccessType("inputOnly").setType("SFTime"))
              .setIS(x3dpsail.IS()
                .addConnect(x3dpsail.connect().setNodeField(x3dpsail.SFString("enabled")).setProtoField(x3dpsail.SFString("enabled")))
...
"''')
        ...
        .addChild(x3dpsail.Group()
          ...
          .addChild(x3dpsail.ProtoDeclare().setName(x3dpsail.SFString("NewWorldInfo"))
            .setProtoInterface(x3dpsail.ProtoInterface()
              .addField(x3dpsail.field().setName(x3dpsail.SFString("description")).setAccessType("initializeOnly").setType("SFString")))
            .setProtoBody(x3dpsail.ProtoBody()
        ...
        .addChild(x3dpsail.Transform().setDEF(x3dpsail.SFString("SpecialtyNodes"))
          ...
          .addChild(x3dpsail.HAnimHumanoid().setDEF(x3dpsail.SFString("TestHumanoidDEF")).setName(x3dpsail.SFString("TestHumanoid")).setVersion("2.0")))))
