...
X3D0 = (x3dpsail.X3D().setProfile("Immersive").setVersion("3.3")
      ...
      .setScene(x3dpsail.Scene()
        .addChild(x3dpsail.ViewpointGroup().setDescription("Available viewpoints")
          .addChild(x3dpsail.Viewpoint().setDEF("DefaultView").setDescription("Hello X3DJSAIL"))
          .addChild(x3dpsail.Viewpoint().setDEF("TopDownView").setDescription("top-down view from above").setOrientation(1,0,0,-1.570796).setPosition(0,100,0)))
        ...
        .addChild(x3dpsail.WorldInfo().setUSE("WorldInfoDEF"))
        .addMetadata(x3dpsail.MetadataString().setDEF("scene.addChildMetadata").setName("test").setValue(["Top-level root Metadata node beneath Scene needs to be one of '-children' in JSON encoding"]))
...
X3D0.toFileX3D("HelloWorldProgramOutput_CommandLine_RoundTrip.x3d")
